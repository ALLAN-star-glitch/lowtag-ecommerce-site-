...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-cream-peach">
      ...
      {/* Owned vs Partner Comparison */}
      <section className="py-16 bg-cream-peach">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-3xl font-bold text-soft-black mb-4 text-center">
            Owned Stock vs Partner Products
          </h2>
          <p className="text-center text-gray-600 mb-12 max-w-2xl mx-auto">
            We offer both owned inventory and partner seller products so you get
            the best of both worlds
          </p>

          <div className="grid md:grid-cols-2 gap-8 mb-12">
            <div className="bg-white rounded-2xl p-8 shadow-lg border-2 border-royal-blue">
              <div className="flex items-center gap-3 mb-4">
                <Badge type="owned" size="lg" />
              </div>
              ...
              <ul className="space-y-3 text-gray-700">
                <li className="flex items-start gap-2">
                  ...
                  <span>Products we own and inspect ourselves</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-royal-blue font-bold">✓</span>
                  <span>Fastest dispatch - usually same day</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-royal-blue font-bold">✓</span>
                  <span>Quality guaranteed with warranty</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-royal-blue font-bold">✓</span>
                  <span>Real inventory - no stock-outs</span>
                </li>
              </ul>
            </div>

            <div className="bg-white rounded-2xl p-8 shadow-lg border-2 border-tangerine">
              <div className="flex items-center gap-3 mb-4">
                <Badge type="partner" size="lg" />
              </div>
              <h3 className="text-2xl font-bold text-soft-black mb-4">
              ...
              <ul className="space-y-3 text-gray-700">
                <li className="flex items-start gap-2">
                  ...
                  <span>Verified sellers we trust and monitor</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-tangerine font-bold">✓</span>
                  <span>Wider variety and competitive prices</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-tangerine font-bold">✓</span>
                  <span>Still protected by Lowtag guarantee</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-tangerine font-bold">✓</span>
